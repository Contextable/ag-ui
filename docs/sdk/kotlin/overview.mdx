...
- **aguiStreamingAgent**: Installs an HTTP endpoint that streams newline-delimited JSON `BaseEvent` flows
- **aguiSseAgent**: Legacy SSE helper retained for experiments (deprecated)
