...
- **Kotlin Koog Adapter** - Run JetBrains Koog agents over AG-UI's HTTP streaming protocol using the community Kotlin SDK, complete with an OpenAI-compatible Docker sample that defaults to Ollama. See [`sdks/community/kotlin/integrations/koog`](https://github.com/ag-ui-protocol/ag-ui/tree/main/sdks/community/kotlin/integrations/koog).
